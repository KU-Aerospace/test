%-------------------------------------------------------------------------
%  Implicit 2nd-order Backward Difference Method
%-------------------------------------------------------------------------
...
%-------------------------------------------------------------------------
       ...
       tau= DeLtau*(J-1)           ;
%-------------------------------------------------------------------------
% (2-1) Implicit 2nd-order Backward Difference Using Picaard Iterative Method
%-------------------------------------------------------------------------
       y1(1:4) = yvec(1:4,Jm)    ;
       yn(1:4) = yvec(1:4, J)    ;
       for it = 1:Iter_max
...
%           
           ...
           y(1:4)  = c1*yn(1:4) + c2*y1(1:4) + c3*dot_y(1:4)       ;
%
