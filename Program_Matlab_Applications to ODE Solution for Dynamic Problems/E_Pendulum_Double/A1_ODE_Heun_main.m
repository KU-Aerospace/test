...
%   Corrector Step
%
       [dot_yp] = ODE_System5_B_Dynamics(yp,t) ;
...
figure(15),
    ...
    p1 = plot(r1_vec(1:Nstep,1) , r1_vec(2:Nstep,1),'or' ); hold on; grid on; xlabel('x'); ylabel('y');
    p2=plot(r1_vec(1:Nstep),r1_vec(2:Nstep,1),'-b'  ) ;
    legend([p1,p2],'Simulation(Heun)','nearly Exact solution')
    title('trajectory')
