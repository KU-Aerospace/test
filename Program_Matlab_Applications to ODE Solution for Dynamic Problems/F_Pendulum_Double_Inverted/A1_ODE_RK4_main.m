...
%
       ...
       [f4] = ODE_System5_B_Dynamics(y4,T4) ;
%
...
%-------------------------------------------------------------------------
    Nstep = Nstep - 1 ;
    x (1:Nstep,1:No_state) = x (1:Nstep,1:No_state)*180/pi ;
    xe(1:Nstep,1:No_state) = xe(1:Nstep,1:No_state)*180/pi ;
%-------------------------------------------------------------------------
...
%
    p1=plot(TT(1:Nstep),x (1:Nstep,1),'or') ; hold on ; grid on ; xlabel('time (s)') ; ylabel('\theta_1 (deg) ') ;
...
%  Time histoty of simulation results
%
    p1=plot(TT(1:Nstep),x (1:Nstep,2),'or') ; hold on ; grid on ; xlabel('time (s)') ; ylabel('\theta_2 (deg) ') ;
...
%  Time histoty of simulation results
%
    p1=plot(TT(1:Nstep),x (1:Nstep,3),'or') ; hold on ; grid on ; xlabel('time (s)') ; ylabel('d\theta_1 /dt (deg/sec)') ;
...
%  Time histoty of simulation results
%
    p1=plot(TT(1:Nstep),x (1:Nstep,4),'or') ; hold on ; grid on ; xlabel('time (s)') ; ylabel('d\theta_2 /dt (deg/sec)') ;
