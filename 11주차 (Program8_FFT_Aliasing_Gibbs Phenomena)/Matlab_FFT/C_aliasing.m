...
figure(2); plot(w1,S1); title('First sampling rate (Peak is at 60 rad/sec)')
...
figure(3); plot(w2,S2); title('Sampling rate halved (Peak is still at 60 rad/sec)')
...
figure(4); plot(w3,S3); title('Sampling rate again halved (Peak is still at 60 rad/sec)')
...
figure(5); plot(w4,S4); title('Sampling rate again halved (60 rad/sec peak)')
fprintf('Frequency spectrum: Sampling rate again halved.\n');
