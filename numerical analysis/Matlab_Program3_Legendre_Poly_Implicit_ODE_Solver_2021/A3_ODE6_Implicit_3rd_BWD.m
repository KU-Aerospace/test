%-------------------------------------------------------------------------
%  Implicit 3rd-order Backward Difference Method
%-------------------------------------------------------------------------
...
%-------------------------------------------------------------------------
       ...
       tau= DeLtau*(J-1)           ;
%-------------------------------------------------------------------------
% (2-1) Implicit 3rd-order Backward Difference Using Picaard Iterative Method
%-------------------------------------------------------------------------
       y2(1:4) = yvec(1:4,Jm2)   ;
       y1(1:4) = yvec(1:4,Jm)    ;
       yn(1:4) = yvec(1:4, J)    ;
...
%           
           ...
           y(1:4)  = c1*yn(1:4) + c2*y1(1:4)  + c3*y2(1:4)+ c4*dot_y(1:4)       ;
%
