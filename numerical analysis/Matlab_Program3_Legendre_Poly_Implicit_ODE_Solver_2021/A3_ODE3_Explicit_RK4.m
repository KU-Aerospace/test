...
%-------------------------------------------------------------------------
       ...
       tau     = DeLtau*(J-1)                   ;
%-------------------------------------------------------------------------
% (2-1) 4-stage Runge-Kutta Method
%-------------------------------------------------------------------------
% 1st atage 
       tau1 = tau ;
       [dot_y1] = ODE_System_Dynamics(y,tau,T)     ;
       y1(1:4)  = y(1:4) + 0.5*DeLtau*dot_y1(1:4)  ;
% 2nd stage 
       tau2 = tau + 0.5*DeLtau ;
       [dot_y2] = ODE_System_Dynamics(y1,tau2,T)     ;
       y2(1:4)  = y(1:4) + 0.5*DeLtau*dot_y2(1:4)  ;
% 3rd stage 
       tau3 = tau + 0.5*DeLtau ;
       [dot_y3] = ODE_System_Dynamics(y2,tau3,T)     ;
       y3(1:4)  = y(1:4) + DeLtau*dot_y3(1:4)  ;
% 4th stage 
       tau4 = tau + DeLtau ;
       [dot_y4] = ODE_System_Dynamics(y3,tau4,T)     ;
%
       y(1:4)  = y(1:4) +DeLtau*( dot_y1(1:4) + 2.0*dot_y2(1:4) +2.0*dot_y3(1:4) + dot_y4(1:4) )/6.0 ;
%-------------------------------------------------------------------------
% (2-2) Exact solution
%-------------------------------------------------------------------------
